                ...
                <form class="row g-3" action="<c:url value="/controller?command=editProfile"/>" method="post">
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="login" name="login" value="${sessionScope.sessionAccount.login}">
                            <label for="login">Login</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="email" class="form-control" id="email" name="email" value="${sessionScope.sessionAccount.email}">
                            <label for="email">Email</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="firstName" name="firstName" value="${sessionScope.sessionAccount.user.firstName}">
                            <label for="firstName">First name</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="secondName" name="secondName" value="${sessionScope.sessionAccount.user.secondName}">
                            <label for="secondName">Second name</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <button type="submit" class="btn btn-lg btn-primary">Принять</button>
                    </div>
                </form>
                <br>
