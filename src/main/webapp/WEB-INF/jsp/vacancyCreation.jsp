            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <s:security level="2">
                    ...
                    <li><a href="<c:url value="/controller?command=jobRequestsPage"/>"
                           class="nav-link px-2">Job requests</a></li>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <form class="row g-3" action="<c:url value="/controller?command=vacancyCreation"/>" method="post">
                    ...
                    <div class="col-12">
                        <select class="form-select" id="employmentType" name="employmentType">
                            <option selected value="null">Тип занятости</option>
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <div class="input-group mb-3">
                                <span class="input-group-text">Опыт работы от:</span>
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <textarea class="form-control" id="description" name="description" placeholder="Описание"
                                      style="height: 100px"></textarea>
                            <label for="description">Описание</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <button type="submit" class="btn btn-lg btn-primary">Создать вакансию</button>
                    </div>
                </form>
                <br>
                <c:if test="${not empty sessionScope.errorMessage}">
                    ...
                    <c:if test="${sessionScope.errorMessage eq 'title is empty'}">
                        <div class="form-floating" role="alert">
                            <div class="alert alert-danger" role="alert">
                                    ${errorMessage}
                            </div>
                    ...
                    <c:if test="${sessionScope.errorMessage eq 'employer name is empty'}">
                        <div class="form-floating" role="alert">
                            <div class="alert alert-danger" role="alert">
                                    ${errorMessage}
                            </div>
                    ...
                    <c:if test="${sessionScope.errorMessage eq 'incorrect salary'}">
                        <div class="form-floating" role="alert">
                            <div class="alert alert-danger" role="alert">
                                    ${errorMessage}
                            </div>
                    ...
                    <c:if test="${sessionScope.errorMessage eq 'incorrect employment'}">
                        <div class="form-floating" role="alert">
                            <div class="alert alert-danger" role="alert">
                                    ${errorMessage}
                            </div>
